...
class HerokuTestSuiteRunner(DjangoTestSuiteRunner):
    def setup_databases(self, **kwargs):
        ...
        for alias in django.db.connections:
            ...
            # make them tables
            call_command('syncdb', verbosity=0, interactive=False, database=test_connection.alias, load_initial_data=False)

            call_command('flush', verbosity=0, interactive=False, database=test_connection.alias)
